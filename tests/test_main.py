...
def test_given_get_when_request_path_is_health_then_response_status_code_should_be_200_ok(
    client,
):
    """
    Given   GET /health/
...
def test_given_get_when_request_is_initial_then_response_header_x_cache_should_be_miss(
    client,
):
    """
    Given   GET /players/
...
def test_given_get_when_request_is_subsequent_then_response_header_x_cache_should_be_hit(
    client,
):
    """
    Given   GET /players/
...
def test_given_get_when_request_path_is_nonexistent_id_then_response_status_code_should_be_404_not_found(
    client,
):
    """
...
def test_given_get_when_request_path_is_nonexistent_squad_number_then_response_status_code_should_be_404_not_found(
    client,
):
    """
...
def test_given_post_when_request_body_is_nonexistent_player_then_response_status_code_should_be_201_created(
    client,
):
    """
    Given   POST /players/
...
def test_given_put_when_request_path_is_unknown_id_then_response_status_code_should_be_404_not_found(
    client,
):
    """
    Given   PUT /players/{player_id}
...
def test_given_put_when_request_path_is_existing_id_then_response_status_code_should_be_204_no_content(
    client,
):
    """
    Given   PUT /players/{player_id}
...
def test_given_delete_when_request_path_is_unknown_id_then_response_status_code_should_be_404_not_found(
    client,
):
    """
